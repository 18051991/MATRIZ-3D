...
#calcular el promedio de temperaturas por cada ciudad y semana

ciudades =["ORELLANA 1", "GUAYAQUIL 2", "LOJA 3"]
...
for ciudad_idx,ciudad in enumerate(temperaturas):
    ...
    for semana_idx, semana in enumerate(ciudad):
        ...
        print(f"Promedio de las temperaturas por en la ciudades {ciudades[ciudad_idx]}, semanas {semana_idx +1} : promedio {promedio} ")